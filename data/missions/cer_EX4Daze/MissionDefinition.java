package data.missions.cer_EX4Daze;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Defense Fleet Gamma with Major Claymore");
		...
		// files in data/variants and data/variants/fighters
				...
				api.addToFleet(FleetSide.PLAYER, "diable_daze_EX_Flagship", FleetMemberType.SHIP,"CESN Merkava", true);
		...
		api.defeatOnShipLoss("CESN Merkava");
