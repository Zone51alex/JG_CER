...
public class diable_JankTeleportEffect implements EveryFrameWeaponEffectPlugin {
    ...
    private float boostAcceleration = 10f;
    private float boostMax = 200f;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        float radius = ship.getCollisionRadius() * 2f;
