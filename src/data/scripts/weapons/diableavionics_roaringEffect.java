...
/*
public class diableavionics_roaringEffect implements EveryFrameWeaponEffectPlugin {
    private final Map<Integer, String> LEFT_SELECTOR;

    public diableavionics_roaringEffect() {
...
/*
        if (!RunOnce) {
            gunSpriteWidth = weapon.getSprite().getWidth();
            gunSpriteHeight = weapon.getSprite().getHeight();
            RunOnce = true;
        }
*/
...
/*
            lbarrel.getSprite().setWidth(2f);
            lbarrel.getSprite().setHeight(4f);
            rbarrel.getSprite().setWidth(2f);
            rbarrel.getSprite().setHeight(4f);
*/
 ...
 /*
            lbarrel.getSprite().setWidth(gunSpriteWidth);
            lbarrel.getSprite().setHeight(gunSpriteHeight);
            rbarrel.getSprite().setWidth(gunSpriteWidth);
            rbarrel.getSprite().setHeight(gunSpriteHeight);
  */
