...
public class Diableavionics_fluxburst extends BaseShipSystemScript {

    private final float 
//            ACCURACY_LOSS = 1f,
            ROF_BONUS_PERCENT = 100,
            BEAM_BONUS_PERCENT = 100,
            FLUX_REDUCTION = 0.8f;
...
//    private Logger log = Global.getLogger(Diableavionics_fluxburst.class);
