...
public class cer_rimemissileselect extends BaseHullMod {
    ...
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        if(toSwitch){
           ...
           int selected;
            ...
            String firstslotID = "BUILTINA";
            String secondslotID = "BUILTINB";
            String thirdslotID = "BUILTINC";
            String fourthslotID = "BUILTIND";
            String fifthslotID = "BUILTINE";
            String sixthslotID = "BUILTINF";
            if(stats.getVariant().getWeaponSpec(firstslotID)!=null){
                selected = SWITCH_TO.get(stats.getVariant().getWeaponSpec(firstslotID).getWeaponId());
            }
            else {
            ...
            stats.getVariant().clearSlot(firstslotID);
            stats.getVariant().clearSlot(secondslotID);
            stats.getVariant().clearSlot(thirdslotID);
            stats.getVariant().clearSlot(fourthslotID);
            stats.getVariant().clearSlot(fifthslotID);
            stats.getVariant().clearSlot(fourthslotID);

            //String toInstallLeft = MAIN_SELECTOR.get(selected);
            String toInstallRight=MAIN_SELECTOR.get(selected);

            stats.getVariant().addWeapon(firstslotID, toInstallRight);
            stats.getVariant().addWeapon(secondslotID, toInstallRight);
            stats.getVariant().addWeapon(thirdslotID, toInstallRight);
            stats.getVariant().addWeapon(fourthslotID, toInstallRight);
            stats.getVariant().addWeapon(fifthslotID, toInstallRight);
            stats.getVariant().addWeapon(sixthslotID, toInstallRight);
