...
public class cer_stormmissileselect extends BaseHullMod {
    ...
    private HashMap<Integer, String> populateMainSelector() {
        ...
        retVal.put(0, "diable_raptorbuiltin");
        retVal.put(1, "diableavionics_magicboxPodBI");
    ...
    private HashMap<String, Integer> populateSwitchTo() {
        ...
        retVal.put("diable_raptorbuiltin",1);
        retVal.put("diableavionics_magicboxPodBI",0);
    ...
    private HashMap<Integer, String> populateSwitch() {
        HashMap<Integer, String> retVal = new HashMap();
        retVal.put(0, "diable_selector_Raptor");
