...
public class DAStratusCore extends BaseHullMod {
...
//to bypass a Java 17 bug,don't blame me i had to debug it myself and this worked.
private HashMap<Integer, String> populateMainSelector() {
    ...
    private HashMap<String, Integer> populateSwitchTo() {
        ...
        retVal.put("diable_magicboxbuiltin",0);
        return retVal;
    }
